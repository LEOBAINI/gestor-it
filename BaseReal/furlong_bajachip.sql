...
--
-- Dumping data for table `bajachip`
--

LOCK TABLES `bajachip` WRITE;
/*!40000 ALTER TABLE `bajachip` DISABLE KEYS */;
/*!40000 ALTER TABLE `bajachip` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-07-25 16:46:11
