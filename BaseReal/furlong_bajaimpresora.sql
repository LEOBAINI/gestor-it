...
--
-- Dumping data for table `bajaimpresora`
--

LOCK TABLES `bajaimpresora` WRITE;
/*!40000 ALTER TABLE `bajaimpresora` DISABLE KEYS */;
/*!40000 ALTER TABLE `bajaimpresora` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-07-24 23:42:01
